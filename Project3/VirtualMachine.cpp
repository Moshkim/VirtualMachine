...
extern "C" {
    ...
    TVMStatus VMFileWrite(int filedescriptor, void *data, int *length){
        ...
        int offset = 0;
        int value_store = 0;
        // char* read_Location = new char[*length+1];
        // strcpy(read_Location,(char*)data);

        //check if data value is a location in the shared memory
        //cout << "write bytes" << tempLength << endl;
